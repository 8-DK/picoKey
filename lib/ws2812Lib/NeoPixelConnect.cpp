...
NeoPixelConnect::NeoPixelConnect(uint pinNumber, uint16_t numberOfPixels) {
    this->pixelSm = 0;
    this->pixelPio = pio0;
...
NeoPixelConnect::NeoPixelConnect(uint pinNumber, uint16_t numberOfPixels, PIO pio, uint sm) {
    this->pixelSm = sm;
    this->pixelPio = pio;
    this->neoPixelInit(pinNumber, numberOfPixels);
}
...
/// @param pinNumber: GPIO pin that controls the NeoPixel string.
/// @param numberOfPixels: Number of pixels in the string
void NeoPixelConnect::neoPixelInit(uint pinNumber, uint16_t numberOfPixels) {
