...
public:
    ...
    NeoPixelConnect(uint pinNumber, uint16_t numberOfPixels);

    /// @brief Constructor
    /// @param pinNumber: GPIO pin that controls the NeoPixel string.
    /// @param numberOfPixels: Number of pixels in the string
    /// This constructor sets pio=pio0 and sm to 0
    NeoPixelConnect(uint pinNumber, uint16_t numberOfPixels, PIO pio, uint sm);
    ...
    /// @param pinNumber: GPIO pin that controls the NeoPixel string.
    /// @param numberOfPixels: Number of pixels in the string
    void neoPixelInit(uint pinNumber, uint16_t numberOfPixels);
